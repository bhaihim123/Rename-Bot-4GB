...
async def handle_metadata(_, message: Message):
...
@app.on_callback_query(filters.regex('.*?(custom_metadata|metadata).*?'))
async def query_metadata(_, query: CallbackQuery):
    ...
    if data.startswith('metadata_'):
        ...
        try:
            ...
            ms = await query.message.reply_text("**Please Wait...**")
